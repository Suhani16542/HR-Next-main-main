              ...
              <div class="card-body">
                <div class="row g-3">
                  ...
                  <div class="col-6">
                    ...
                    <input type="tel" name="phone" class="form-control" id="phone" placeholder="{{ __('+91 XXXXXXXXXX') }}" value="{{ $employee->phone }}" required oninput="formatPhoneNumber(this)" maxlength="19" />
                  </div>
                  <div class="col-6">
